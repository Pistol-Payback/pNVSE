...
public:
	...
	//{
		//return 0; //ThisCall<NiTriShapeData*>(0xA7B630, Ni_Alloc<NiTriShapeData>(), numVertices, vertices, normals, vertexColor, uvCoords, 0, 0, numTriangles, triangles);
	//}
...
//t(sizeof(BSShaderProperty) == 0x60); FixedTypeArray<hkpWorldObject*, 0x40> ContactObjects;